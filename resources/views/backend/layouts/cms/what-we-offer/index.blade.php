        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> what We Offer Section </li>
            ...
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <div class="card card-body">
                        <form method="POST" action="{{ route('admin.cms.what_we_offer.update') }}"
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="text" placeholder="Enter Title" id="title"
                                    ...
                                    value="{{ $what_we_offer->title ?? old('title') }}" />
                                @error('title')
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="text" placeholder="Enter Title" id="sub_title"
                                    ...
                                    value="{{ $what_we_offer->sub_title ?? old('sub_title') }}" />
                                @error('sub_title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
