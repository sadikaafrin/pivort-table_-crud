        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Hero Section </li>
            ...
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <div class="card card-body">
                        <form method="POST" action="{{ route('admin.cms.hero_section.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="input-style-1 mt-4">
                               ...
                               <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="7">{{  $hero_section->description ?? old('description') }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="file" id="image"
                                    ...
                                    value="{{ old('image_url') }}" data-default-file="{{ asset( $hero_section->image_url ?? 'backend/images/placeholder/image_placeholder.png') }}" />
                                @error('image_url')
