...
@section('title', 'Version Category')
        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Version </li>
                    <li class="breadcrumb-item text-muted"> Version Category </li>
...
@push('script')
    <script>
        ...
        function statusChange(id) {
            let url = "{{ route('admin.version.status', ':id') }}";
            $.ajax({
                type: "POST",
        ...
        function deleteItem(id) {
            let url = "{{ route('admin.version.destroy', ':id') }}";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            $('#create-form').on('submit', function(e) {
                ...
                let url = "{{ route('admin.version.store') }}";
        ...
        $('body').on('click', '.edit', function() {
            var id = $(this).data('id');
            var url = "{{ route('admin.version.edit', ':id') }}".replace(':id', id);
        ...
        $('#edit-form').on('submit', function(e) {
            ...
            var url = "{{ route('admin.version.update') }}";
