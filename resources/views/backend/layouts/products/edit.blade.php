        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Products Edit </li>
                    ...
                    <div class="card card-body">
                        <form method="POST" action="{{ route('admin.products.update', $data->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <select name="category_id" class="form-control dropdown @error('category_id') is-invalid @enderror" id="category_id">
