...
@push('script')
    <script>
        ...
        function statusChange(id) {
            let url = "{{ route('admin.blog.categories.status', ':id') }}";
            $.ajax({
                type: "POST",
        ...
        function deleteItem(id) {
            let url = "{{ route('admin.blog.categories.destroy', ':id') }}";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            $('#create-form').on('submit', function(e) {
                ...
                let url = "{{ route('admin.blog.categories.store') }}";
        ...
        $('body').on('click', '.edit', function() {
            var id = $(this).data('id');
            var url = "{{ route('admin.blog.categories.edit', ':id') }}".replace(':id', id);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#edit-form').append(
                            '<input type="text" hidden id="category_id" name="id" value="' +
                            response.data
                            .id + '">');
        ...
        $('#edit-form').on('submit', function(e) {
            ...
            var url = "{{ route('admin.blog.categories.update') }}";
